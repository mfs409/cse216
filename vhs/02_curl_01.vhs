...
# cp -R ../02_javalin/backend_04/ ~/Desktop/sweng/dev/backend/
...
Sleep 1s
Type "curl http://localhost:3000/people"
Sleep 1s
Enter
Enter

Sleep 1s
Type "curl --verbose http://localhost:3000/people"
Sleep 1s
Enter
Enter

Sleep 1s
Type "curl http://localhost:3000/people -b 'auth.gId=111044916034782695562; auth.email=mfs409@lehigh.edu; auth.name=TWljaGFlbCBTcGVhcg==; auth.id=1; auth.key=MubUx0dYdU6ahZV5u2hNx'"
Sleep 1s
Enter
Enter
